...
#ifndef ROTORS_JOY_INTERFACE_JOY_POSE_FOLLOWER_H_
#define ROTORS_JOY_INTERFACE_JOY_POSE_FOLLOWER_H_
...
#endif // ROTORS_JOY_INTERFACE_JOY_POSE_FOLLOWER_H_
